...
from glycogen.desktop import pathwaylayout

_logger = logging.getLogger('FavoritesView')

_ICON_DND_TARGET = ('activity-icon', gtk.TARGET_SAME_WIDGET, 0)

LAYOUT_MAP = {pathwaylayout.RingPathwayLayout.key: pathwaylayout.RingPathwayLayout,
        #pathwaylayout.BoxLayout.key: pathwaylayout.BoxLayout,
        #pathwaylayout.TriangleLayout.key: pathwaylayout.TriangleLayout,
        #pathwaylayout.SunflowerLayout.key: pathwaylayout.SunflowerLayout,
        pathwaylayout.RandomPathwayLayout.key: pathwaylayout.RandomPathwayLayout}
...
class PathwayView(hippo.Canvas):
    __gtype_name__ = 'SugarPathwayView'
    ...
    def _set_layout(self, layout):
        if layout not in LAYOUT_MAP:
            ...
            layout = pathwaylayout.RingPathwayLayout.key
...
class ActivityIcon(CanvasIcon):
    __gtype_name__ = 'SugarPathwayActivityIcon'
...
class FavoritePalette(ActivityPalette):
    __gtype_name__ = 'SugarPathwayPalette'
...
class OwnerIcon(BuddyIcon):
    __gtype_name__ = 'SugarPathwayOwnerIcon'
