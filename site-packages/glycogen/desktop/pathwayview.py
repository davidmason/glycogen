...
class PathwayView(gtk.VBox):
    ...
    def __init__(self, **kwargs):
        ...
        self.pack_start(self.activity_list, True, True, 0)
        self.activity_list.show()
        
        self.challenge_list = ChallBox()
        self.pack_start(self.challenge_list, True, True, 0)
        self.challenge_list.show()
        
        #TODO link activity selection to challenge lookup
        self.activity_list.connect('cursor-changed', self.activity_selected_cb)
        
        self.show()
        
        
        #self.challenge_list.show_challenges(None)
        
    def activity_selected_cb(self, widget, data=None):
        #get bundle id from activity list
