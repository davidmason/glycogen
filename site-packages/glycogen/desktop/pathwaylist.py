...
class PathwayList(gtk.VBox):
    ...
    def __init__(self):
        ...
        btn_box = gtk.HBox(True, 0)
        btn_box.show()
        
        self._btn_new_pathway = gtk.Button("Add pathway")
        btn_box.pack_start(self._btn_new_pathway, True, False, 0)
        self._btn_new_pathway.show()
        
        self._btn_del_pathway = gtk.Button("Delete pathway")
        btn_box.pack_start(self._btn_del_pathway, True, False, 0)
        self._btn_del_pathway.show()
    ...
    def update(self):
        """ Fetches the most recent list of pathways from the repository and displays them """
