...
_logger = logging.getLogger('PathwayLayout')
...
class PathwayLayout(gobject.GObject, hippo.CanvasLayout):
    """Base class of the different layout types."""

    __gtype_name__ = 'PathwayLayout'
...
class RandomPathwayLayout(PathwayLayout):
    """Lay out icons randomly; try to nudge them around to resolve overlaps."""

    __gtype_name__ = 'RandomPathwayLayout'
    ...
    def append(self, icon, locked=False):
        PathwayLayout.append(self, icon, locked)
    ...
    def remove(self, icon):
        ...
        PathwayLayout.remove(self, icon)

    def move_icon(self, icon, x, y, locked=False):
        self._grid.move(icon, x / _CELL_SIZE, y / _CELL_SIZE, locked)
        PathwayLayout.move_icon(self, icon, x, y, locked)
...
class RingPathwayLayout(PathwayLayout):
    """Lay out icons in a ring or spiral around the XO man."""

    __gtype_name__ = 'RingPathwayLayout'
...
"""
Compute a starting index for the `SunflowerPathwayLayout` which leaves space for
...
class SunflowerPathwayLayout(RingPathwayLayout):
    ...
    __gtype_name__ = 'SunflowerPathwayLayout'
    ...
    def __init__(self):
        RingPathwayLayout.__init__(self)
        self.skipped_indices = []

    def _calculate_radius_and_icon_size(self, children_count):
        """Stub out this method; not used in `SunflowerPathwayLayout`."""
...
class BoxPathwayLayout(RingPathwayLayout):
    """Lay out icons in a square around the XO man."""

    __gtype_name__ = 'BoxPathwayLayout'
    ...
    def _calculate_position(self, radius, icon_size, index, children_count,
        ...
        return RingPathwayLayout._calculate_position\
               (self, radius, icon_size, index, children_count,
                sin=sin, cos=cos)

class TrianglePathwayLayout(RingPathwayLayout):
    """Lay out icons in a triangle around the XO man."""

    __gtype_name__ = 'TrianglePathwayLayout'
    ...
    def _calculate_radius_and_icon_size(self, children_count):
        ...
        radius, icon_size = \
            RingPathwayLayout._calculate_radius_and_icon_size(self, children_count)
